...
async def start_private_chat(message: Message, state: FSMContext) -> None:
    ...
    await message.answer(
        ...
        "Что я умею:\n"
        "🔍 **Умный поиск**: Пиши в любом чате через инлайн-режим (@MIFki_botзапрос) — я мгновенно поищу звук в базе t.me/MIFFFki, а если его нет, автоматически сбегаю на MyInstants и сам скачаю!\n"
